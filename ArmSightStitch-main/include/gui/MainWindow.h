...
private slots:
    ...
    void on_rotationCombo_currentIndexChanged(int index);
...
private:
    ...
    QGroupBox *spherical_cap_group_;
    QSpinBox *cap_radius_spin_;
    QSpinBox *cap_height_spin_;
    QSpinBox *delta_h_spin_;
    ...
    QCheckBox *auto_exposure_checkbox_;
    ...
    QGroupBox *image_rotation_group_;
    QComboBox *rotation_combo_;
    QPushButton *apply_rotation_button_;
    
    QGroupBox *crop_region_group_;
    QSpinBox *crop_width_spin_;
    QSpinBox *crop_height_spin_;
    QPushButton *set_crop_button_;
